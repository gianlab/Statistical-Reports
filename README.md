...
<table width="643" cellpadding="4" cellspacing="0">
	...
	<col width="374">
	<tr valign="top">
		<td width="29" style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0.1cm; padding-bottom: 0.1cm; padding-left: 0.1cm; padding-right: 0cm">
			<p><b>n.</b></p>
		</td>
		...
		<td width="374" style="border: 1px solid #000000; padding: 0.1cm">
			<p><b>Description :</b></p>
		</td>
	</tr>
	<tr valign="top">
		...
		<td width="139" style="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0cm; padding-bottom: 0.1cm; padding-left: 0.1cm; padding-right: 0cm">
			<p>Statistical Inference with GSS data.md</p>
		</td>
		<td width="374" style="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-top: 0cm; padding-bottom: 0.1cm; padding-left: 0.1cm; padding-right: 0.1cm">
			<p>Family income and qualifications of US women : assignment of
			course “Inferential Statistics” by Duke University</p>
		</td>
	</tr>
	<tr valign="top">
		<td width="29" style="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0cm; padding-bottom: 0.1cm; padding-left: 0.1cm; padding-right: 0cm">
		...
		<td width="139" style="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0cm; padding-bottom: 0.1cm; padding-left: 0.1cm; padding-right: 0cm">
			<p>Modeling and prediction for movies.md</p>
		</td>
		<td width="374" style="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-top: 0cm; padding-bottom: 0.1cm; padding-left: 0.1cm; padding-right: 0.1cm">
			<p>Relation between the genre’s  movie  and audience score :
			assignment of course “Linear Regression and Modeling” by Duke
			University</p>
		</td>
	</tr>
	<tr valign="top">
		...
		<td width="139" style="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0cm; padding-bottom: 0.1cm; padding-left: 0.1cm; padding-right: 0cm">
			<p>Practical Machine Learning.md</p>
		</td>
		<td width="374" style="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-top: 0cm; padding-bottom: 0.1cm; padding-left: 0.1cm; padding-right: 0.1cm">
			<p>Is it possible to predict which type of class A, B, C, D, E a
			weight lifting exercise will belong :  assignment of course
			“Practical Machine Learning” by Johns Hopkins University</p>
		</td>
	</tr>
	<tr valign="top">
		<td width="29" style="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0cm; padding-bottom: 0.1cm; padding-left: 0.1cm; padding-right: 0cm">
		...
		<td width="139" style="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0cm; padding-bottom: 0.1cm; padding-left: 0.1cm; padding-right: 0cm">
			<p>Predicting total quantity of products.md</p>
		</td>
		<td width="374" style="border-top: none; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; padding-top: 0cm; padding-bottom: 0.1cm; padding-left: 0.1cm; padding-right: 0.1cm">
			<p>Relation between sub category , market, region of a product and
